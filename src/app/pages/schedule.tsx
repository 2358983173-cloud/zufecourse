  ...
  return (
    <PageWrapper>
      <header className="px-6 pt-10 pb-6 bg-gray-50">
        ...
        <h1 className="text-3xl font-black text-gray-900 mt-1">我的课表</h1>
        <p className="text-sm text-gray-400 font-medium mt-2">根据当前课程路径生成的示例周课表。</p>
      </header>

      <section className="px-6">
        <div className="rounded-[36px] bg-gray-900 text-white p-7 shadow-xl shadow-gray-200">
          <CalendarDays size={34} className="text-blue-300 mb-6" />
          ...
          <p className="text-sm text-white/50 mt-3 leading-relaxed">后续可继续根据备选课程生成多套方案。</p>
        </div>
      </section>
        ...
        <div className="space-y-4">
          {schedule.map((item, index) => (
            <motion.button
              ...
              className="w-full bg-white rounded-[30px] border border-gray-100 p-5 shadow-sm text-left"
            >
