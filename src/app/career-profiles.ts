...
export const careerProfiles: CareerProfile[] = [
  {
    ...
    courses: ["公司金融", "证券投资学", "金融市场学", "固定收益证券", "权益投资", "投资组合管理", "基金管理", "期货与期权", "企业价值评估", "财务报告分析"],
    skills: ["行业研究能力", "财务报表分析能力", "投资判断能力", "信息整理与表达能力", "估值建模能力"],
    coursePath: ["金融学基础", "公司金融", "证券投资学", "财务报告分析", "投资组合管理", "企业价值评估 / 基金管理"],
  ...
  },
  {
    ...
    courses: ["商业银行业务与经营", "商业银行信贷管理", "银行风险管理", "金融风险管理", "金融监管学", "中央银行学", "银行会计", "固定收益证券", "国际金融风险管理"],
    skills: ["风险识别能力", "信贷分析能力", "合规意识", "金融业务理解能力", "材料审核与判断能力"],
    coursePath: ["金融学基础", "商业银行业务与经营", "商业银行信贷管理", "金融风险管理", "金融监管学", "银行风险管理"],
  ...
  },
  {
    ...
    courses: ["会计学", "金融业会计", "财务报告分析", "公司金融", "公司财务案例", "企业并购与重组", "公司治理", "资本运营", "企业价值评估"],
    skills: ["财务报表分析能力", "会计基础能力", "成本与预算意识", "企业经营理解能力", "数据准确性和细节处理能力"],
    coursePath: ["会计学", "公司金融", "财务报告分析", "公司财务案例", "企业价值评估", "企业并购与重组"],
  ...
  },
  {
    ...
    courses: ["Python程序设计", "统计学", "计量经济学", "金融计量学", "金融计量分析与应用", "数字金融", "金融科技", "金融数据分析与编程", "金融数据挖掘", "量化投资方法与应用", "人工智能与金融应用", "大数据技术导论", "区块链技术与应用"],
    skills: ["Python 与数据处理能力", "统计与计量基础", "金融业务理解能力", "模型应用能力", "产品与工具思维"],
    coursePath: ["Python程序设计", "统计学", "计量经济学", "金融数据分析与编程", "金融科技", "量化投资方法与应用 / 人工智能与金融应用"],
  ...
  },
  {
    ...
    courses: ["个人理财", "基金管理", "保险学原理", "信托与租赁", "金融市场学", "公司金融", "证券投资学", "商业银行业务与经营", "国际结算"],
    skills: ["客户沟通能力", "资产配置理解能力", "理财方案设计能力", "产品理解能力", "表达与信任建立能力"],
    coursePath: ["金融学基础", "金融市场学", "个人理财", "基金管理", "保险学原理", "信托与租赁 / 商业银行业务与经营"],
  ...
  },
  {
    ...
    courses: ["微积分", "线性代数", "概率论与数理统计", "微观经济学", "宏观经济学", "计量经济学", "统计学", "金融学", "公司金融", "金融经济学", "金融计量学"],
    skills: ["数学基础", "经济学理论理解能力", "计量与统计能力", "英语阅读能力", "长期复习与自律能力"],
    coursePath: ["微积分", "线性代数", "概率论与数理统计", "微观经济学 / 宏观经济学", "计量经济学", "金融学 / 公司金融 / 金融经济学"],
